...
public class TeacherEntityDao extends AbstractDao<TeacherEntity, Void> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Click = new Property(11, String.class, "click", false, "CLICK");
        public final static Property Apply_job = new Property(12, String.class, "apply_job", false, "APPLY_JOB");
        public final static Property Demand_fee = new Property(13, String.class, "demand_fee", false, "DEMAND_FEE");
        public final static Property Service_type = new Property(14, String.class, "service_type", false, "SERVICE_TYPE");
        public final static Property Service_type_txt = new Property(15, String.class, "service_type_txt", false, "SERVICE_TYPE_TXT");
        public final static Property Grade_type_txt = new Property(16, String.class, "grade_type_txt", false, "GRADE_TYPE_TXT");
        public final static Property Is_passed = new Property(17, String.class, "is_passed", false, "IS_PASSED");
        public final static Property Haoping_num = new Property(18, String.class, "haoping_num", false, "HAOPING_NUM");
        public final static Property Order_rank = new Property(19, String.class, "order_rank", false, "ORDER_RANK");
        public final static Property Distance = new Property(20, String.class, "distance", false, "DISTANCE");
        public final static Property Status1 = new Property(21, String.class, "status1", false, "STATUS1");
        public final static Property Status2 = new Property(22, String.class, "status2", false, "STATUS2");
        public final static Property Signature = new Property(23, String.class, "signature", false, "SIGNATURE");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TEACHER_ENTITY\" (" + //
                ...
                "\"YEARS\" TEXT," + // 10: years
                "\"CLICK\" TEXT," + // 11: click
                "\"APPLY_JOB\" TEXT," + // 12: apply_job
                "\"DEMAND_FEE\" TEXT," + // 13: demand_fee
                "\"SERVICE_TYPE\" TEXT," + // 14: service_type
                "\"SERVICE_TYPE_TXT\" TEXT," + // 15: service_type_txt
                "\"GRADE_TYPE_TXT\" TEXT," + // 16: grade_type_txt
                "\"IS_PASSED\" TEXT," + // 17: is_passed
                "\"HAOPING_NUM\" TEXT," + // 18: haoping_num
                "\"ORDER_RANK\" TEXT," + // 19: order_rank
                "\"DISTANCE\" TEXT," + // 20: distance
                "\"STATUS1\" TEXT," + // 21: status1
                "\"STATUS2\" TEXT," + // 22: status2
                "\"SIGNATURE\" TEXT);"); // 23: signature
    }
    ...
    protected void bindValues(SQLiteStatement stmt, TeacherEntity entity) {
        ...
        if (status1 != null) {
            stmt.bindString(22, status1);
        }
 
        String status2 = entity.getStatus2();
        if (status2 != null) {
            stmt.bindString(23, status2);
        }
 
        String signature = entity.getSignature();
        if (signature != null) {
            stmt.bindString(24, signature);
        }
    }
    ...
    public TeacherEntity readEntity(Cursor cursor, int offset) {
        TeacherEntity entity = new TeacherEntity( //
            ...
            cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11), // click
            cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12), // apply_job
            cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13), // demand_fee
            cursor.isNull(offset + 14) ? null : cursor.getString(offset + 14), // service_type
            cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15), // service_type_txt
            cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16), // grade_type_txt
            cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17), // is_passed
            cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18), // haoping_num
            cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19), // order_rank
            cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20), // distance
            cursor.isNull(offset + 21) ? null : cursor.getString(offset + 21), // status1
            cursor.isNull(offset + 22) ? null : cursor.getString(offset + 22), // status2
            cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23) // signature
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TeacherEntity entity, int offset) {
        ...
        entity.setClick(cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11));
        entity.setApply_job(cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12));
        entity.setDemand_fee(cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13));
        entity.setService_type(cursor.isNull(offset + 14) ? null : cursor.getString(offset + 14));
        entity.setService_type_txt(cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15));
        entity.setGrade_type_txt(cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16));
        entity.setIs_passed(cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17));
        entity.setHaoping_num(cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18));
        entity.setOrder_rank(cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19));
        entity.setDistance(cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20));
        entity.setStatus1(cursor.isNull(offset + 21) ? null : cursor.getString(offset + 21));
        entity.setStatus2(cursor.isNull(offset + 22) ? null : cursor.getString(offset + 22));
        entity.setSignature(cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23));
     }
