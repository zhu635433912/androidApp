...
public class FlexibleScrollView extends ScrollView {
    ...
    private static final int DEFAULT_SCROLL_HEIGHT = 400;
...
//        Log.d("aa",getScaleY()+"--getScaleY---"+oldl+"--oldl--"+oldt+"---oldt");
...
//        Log.d("aa","deltaX22"+ deltaX+"deltaY"+ deltaY+"scrollX"+ scrollX+"scrollY"+ scrollY);
