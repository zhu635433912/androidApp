...
public class StudentVipActivity extends MyBaseActivity implements PayView {
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            switch (resultStatus){
                case "9000":
                    Toast.makeText(StudentVipActivity.this,"订单支付成功",Toast.LENGTH_SHORT).show();
//                    startActivity(new Intent(StudentVipActivity.this,VipCompleteActivity.class));
                    startActivity(VipCompleteActivity_.intent(StudentVipActivity.this).get());
                    StudentVipActivity.this.finish();
                    break;
                case "8000":
                    Toast.makeText(StudentVipActivity.this,"正在处理中，支付结果未知（有可能已经支付成功）!",Toast.LENGTH_SHORT).show();
                    break;
                case "4000":
                    Toast.makeText(StudentVipActivity.this,"订单支付失败",Toast.LENGTH_SHORT).show();
                    break;
                case "5000":
                    Toast.makeText(StudentVipActivity.this,"重复请求",Toast.LENGTH_SHORT).show();
                    break;

                case "6001":
                    Toast.makeText(StudentVipActivity.this,"取消支付",Toast.LENGTH_SHORT).show();
                    break;
                case "6002":
                    Toast.makeText(StudentVipActivity.this,"网络连接出错",Toast.LENGTH_SHORT).show();
                    break;
                case "6004":
                    Toast.makeText(StudentVipActivity.this,"支付结果未知（有可能已经支付成功）",Toast.LENGTH_SHORT).show();
                    break;
            }
    ...
    public void initView() {
        ...
        fiveLl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                flag = 2;
                fiveImage.setImageResource(R.mipmap.choose_ok_gou);
                twoImage.setImageDrawable(null);
                adImage1.setImageResource(R.mipmap.vip_ad1);
            }
        });
        twoLl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                flag = 1;
                twoImage.setImageResource(R.mipmap.choose_ok_gou);
                fiveImage.setImageDrawable(null);
                adImage1.setImageResource(R.mipmap.vip_ad11);
            }
        });
        ...
        descTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(VipDescActivity_.intent(StudentVipActivity.this).extra("type",3).get());
            }
        });
    ...
    private void showmyDialog() {
        ...
        codePopwindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                backgroundAlpha(StudentVipActivity.this, 1f);
            }
        });
        nextTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                payUtil.getVipPay(Integer.parseInt(User_id.getUid()),flag,channl,"",StudentVipActivity.this);
        ...
        buyTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (codeEdit.getText().length()==11){
                    payUtil.getVipPay(Integer.parseInt(User_id.getUid()),flag,channl,codeEdit.getText().toString(),StudentVipActivity.this);
                }else {
                    Toast.makeText(StudentVipActivity.this, "请输入正确的邀请码", Toast.LENGTH_SHORT).show();
                }
                codePopwindow.dismiss();
            }
        });
...
//            Log.e("aa", ordert);
            Runnable payRunnable = new Runnable() {
                ...
                public void run() {
//                    Log.e("aa", "唤起支付宝");
                    PayTask alipay = new PayTask(StudentVipActivity.this);
