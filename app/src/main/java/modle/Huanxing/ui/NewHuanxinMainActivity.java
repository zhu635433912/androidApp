...
@SuppressLint("NewApi")
public class NewHuanxinMainActivity extends BaseActivity {

    protected static final String TAG = "NewHuanxinMainActivity";
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if(action.equals(Constant.ACTION_GROUP_CHANAGED)){
                    if (EaseCommonUtils.getTopActivity(NewHuanxinMainActivity.this).equals(GroupsActivity.class.getName())) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    if (ChatActivity.activityInstance != null && ChatActivity.activityInstance.toChatUsername != null &&
                        ...
                        Toast.makeText(NewHuanxinMainActivity.this, ChatActivity.activityInstance.getToChatUsername() + st10, Toast.LENGTH_LONG)
                                .show();
...
//		}
    ...
    private void showExceptionDialog(String exceptionType) {
        ...
        if (!NewHuanxinMainActivity.this.isFinishing()) {
            // clear up global variables
            try {
                if (exceptionBuilder == null)
                    exceptionBuilder = new android.app.AlertDialog.Builder(NewHuanxinMainActivity.this);
...
//                startActivity(intent2);
                        ...
                        Intent intent = new Intent(NewHuanxinMainActivity.this, LoginAcitivity.class);
...
//                startActivity(intent2);
                                ...
                                finish();
                                startActivity(new Intent(NewHuanxinMainActivity.this, LoginAcitivity.class));
                            }
                        });
                    }
