...
public class BaseActivity extends SwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jbase);
                    ...
                    public void onClick(View v) {
                        switch (v.getId()) {
                            case R.id.jmui_cancel_btn:
                                Intent intent = new Intent(BaseActivity.this, LoginAcitivity.class);
                                startActivity(intent);
                                break;
...
//                                    }
//                                });
                                Intent intent1 = new Intent(BaseActivity.this, LoginAcitivity.class);
